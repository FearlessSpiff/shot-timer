...
Battery percentage is read from the XIAO nRF52840 Sense's onboard divider (`P0.14`/`VBAT_ENABLE` gates `P0.31`/`PIN_VBAT`) — no extra wiring needed beyond the `BAT+`/`BAT-` connection already shown above.
